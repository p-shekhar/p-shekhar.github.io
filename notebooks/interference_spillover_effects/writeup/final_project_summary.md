...
Evaluate promotion policies with slate-level total effects and promoted-item outcomes. When items compete for visibility, monitor substitute or displaced-item spillovers. Advanced models can help target safer promotions and should be validated against randomized or valid off-policy benchmarks.
